...
then
  ...
  then
    ...
    docker-compose -f ./project_files/docker-compose-${env}.yaml up -d > /dev/null
    docker-compose -f ./project_files/docker-compose-${env}.yaml ps
  else
    docker-compose -f ./project_files/docker-compose-${env}.yaml stop
    docker-compose -f ./project_files/docker-compose-${env}.yaml rm --force
    docker-compose -f ./project_files/docker-compose-${env}.yaml ps
  fi
elif [ ${env} = "test" ]
then
  ...
  then
    ...
    docker-compose -f ./project_files/docker-compose-${env}.yaml build > /dev/null
    docker-compose -f ./project_files/docker-compose-${env}.yaml up -d
