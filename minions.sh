...
then
  ...
  then
    ...
    docker run --rm -u gradle -v "$PWD":/home/gradle/project -w /home/gradle/project gradle:6.7-jdk11 gradle build -x test
    docker run --rm -u gradle -v "$PWD"/project_files/spiders:/home/gradle/project -w /home/gradle/project gradle:6.7-jdk11 gradle build -x test
